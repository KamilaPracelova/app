        ...
        User.getUsers().then(function(data) {
            ...
            if (data.data.success) {
                ...
                if (data.data.permission === 'admin' || data.data.permission === 'curator') {
                    ...
                    // Check if logged in user is an admin or curator
                    if (data.data.permission === 'admin') {
                        app.editAccess = true; // Show edit button
                        app.deleteAccess = true; // Show delete button
                    } else if (data.data.permission === 'curator') {
                        app.editAccess = true; // Show edit button
                    }
                } else {
...
.controller('editCtrl', function($scope, $routeParams, User, $timeout) {
    ...
    app.permissionsPhase = function() {
        ...
        app.disableCurator = false; // Disable buttons while processing
        ...
        } else if ($scope.newPermission === 'curator') {
            app.disableCurator = true; // Disable 'curator' button
    ...
    app.updatePermissions = function(newPermission) {
        ...
        app.disableCurator = true; // Disable button while processing
            ...
            if (data.data.success) {
                ...
                $timeout(function() {
                    ...
                    if (newPermission === 'user') {
                        ...
                        app.disableCurator = false; // Unlock the 'curator' button
                        app.disableAdmin = false; // Unlock the 'admin' button
                    } else if (newPermission === 'curator') {
                        app.disableCurator = true; // Lock the 'curator' button
